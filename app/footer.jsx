  ...
  return (
    <footer>
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        {/* Top area: Blocks */}
        <div className='flex flex-col md:flex-row justify-between sm:grid-cols-12 gap-8 py-8 md:py-12'>
          {/* 1st block */}
          <div className='sm:col-span-12 lg:col-span-4 lg:max-w-xs'>
            ...
            <div className='text-lg font-bold text-slate-800'>Cumulation</div>
          </div>

          {/* 2nd block */}
          <div className='sm:col-span-6 md:col-span-3 lg:col-span-2'>
            <h6 className='text-sm text-blue-900 font-semibold mb-2'>
              How it works
            </h6>
        ...
        {/* Bottom area */}
        <div className='flex items-center justify-center py-6 md:py-8 border-t border-slate-200'>
          {/* Social links */}
          ...
          {/* Copyrights note */}
          <div className='text-sm text-center text-slate-500 mr-4'>
            © Cumulation.com. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
